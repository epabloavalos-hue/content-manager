        ...
        <div className="bg-[#0f1a0f]/90 backdrop-blur border border-[#1f3320] rounded-2xl p-8 shadow-2xl">
          {!done ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-400 mb-1.5">Equipo / Área</label>
                <select
                ...
                >
                  ...
                  {areas.map((a) => (
                    <option key={a.value} value={a.value} style={{ color: "white", background: "#162216" }}>{a.label}</option>
                  ))}
                </select>
              </div>
